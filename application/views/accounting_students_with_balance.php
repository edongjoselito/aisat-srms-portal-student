                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Students with Balance</h4>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title mb-4"><b>STUDENTS WITH ACCOUNT BALANCE</b></h4>
										
										<table>
											<tr>
												<td>Course</td><td>: <?php echo $_GET['course']; ?></td>
											</tr>
											<tr>
												<td>Year Level</td><td>: <?php echo $_GET['yearlevel']; ?> Year</td>
											</tr>
											<tr>
												<td>Sem./SY</td><td>: <?php echo $this->session->userdata('semester');?>, SY <?php echo $this->session->userdata('sy');?></td>
											</tr>
										</table>
