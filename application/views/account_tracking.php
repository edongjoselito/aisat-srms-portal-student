                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Account Tracking</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                       <h4 class="m-t-0 header-title mb-4"><b>Account Tracking</b></h4>
								<?php
								if(!$data)
															{
																//the value is null
								...
								<table>
									<tr>
										<td>Student Name</td><td>: <b> <?php echo $data[0]->FirstName.' '.$data[0]->MiddleName.' '.$data[0]->LastName; ?></b></td>
									</tr>
									<tr>
