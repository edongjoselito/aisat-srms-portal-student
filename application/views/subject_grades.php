                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
										...
										<h4 class="m-t-0 header-title mb-1"><b>Report of Grades</b>
											<br />
											<span class="badge badge-primary mb-1"> <b>SY <?php echo $this->session->userdata('sy');?> <?php echo $this->session->userdata('semester');?></span>
										</h4>
