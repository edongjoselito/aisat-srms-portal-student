                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body table-responsive">
                                      <h4 class="m-t-0 header-title mb-4"><b>PAYMENT History, <small><?php echo $this->session->userdata('semester');?>, SY <?php echo $this->session->userdata('sy');?></small></b></h4>
									<?php
								if(!$data)
															{
																//the value is null
									...
									<table>
										<tr>
											<td>Student Name</td><td>: <b> <?php echo $data[0]->StudentName; ?></b></td>
										</tr>
										<tr>
											<td>Course</td><td>: <b><?php echo $data[0]->Course; ?></b></td>
										</tr>
									</table>
									<table class="table">
										<tr>
