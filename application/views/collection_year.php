                                ...
                                <div class="card">
                                    <div class="card-body">
										...
										<div class="form-group">										
										   <input type="text" class="form-control" name="year" placeholder="Year (e.g. 2020)" />&nbsp
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title mb-4"><b>Collection Per Year</b></h4>
										<table>
											<tr>
												<td>Year</td><td>: <b><?php echo $_GET['year']; ?></b></td>
											</tr>
											<tr>
