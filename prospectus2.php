...
<div id="wrapper">
    ...
    <?php if(isset($_POST['submit'])){
     ...
     <form class="prospectus-form" action="prospectus2.php" method="post">
       <input type="text" name="student_name" value="" />
       <select name="course">
         <?php
           $course_set = find_all_course1();
  ...
  <?php //SUMMER  
        $subject_set = find_subject_by_yearlevel_semester_course('2nd', 'Summer', $course);
        if(mysqli_num_rows($subject_set)){
      ?>
      

      <h1 class="prospectus-heading">SECOND YEAR: SUMMER</h1>
      <table class="prospectus-table" border="0" cellpadding="0" cellspacing="0">
      ...
      <?php //third year 1st sem ?>
      
      <h1 class="prospectus-heading">THIRD YEAR: 1ST SEMESTER</h1>
      <table class="prospectus-table" border="0" cellpadding="0" cellspacing="0">

        <?php
          echo $table_header;
          $subject_set = find_subject_by_yearlevel_semester_course('3rd', '1st Sem.', $course);
          while($subject = mysqli_fetch_assoc($subject_set)){ ?>
      ...
      <?php //third year 2nd sem ?>
      
      <h1 class="prospectus-heading">THIRD YEAR: 2ND SEMESTER</h1>
      <table class="prospectus-table" border="0" cellpadding="0" cellspacing="0">

        <?php
          echo $table_header;
          $subject_set = find_subject_by_yearlevel_semester_course('3rd', '2nd Sem.', $course);
          while($subject = mysqli_fetch_assoc($subject_set)){ ?>
      ...
      <?php //SUMMER  
        $subject_set = find_subject_by_yearlevel_semester_course('3rd', 'Summer', $course);
        if(mysqli_num_rows($subject_set)){
      ?>
      

      <h1 class="prospectus-heading">THIRD YEAR: SUMMER</h1>
      <table class="prospectus-table" border="0" cellpadding="0" cellspacing="0">
      ...
      <?php //FOURTH year 1st sem ?>
      
      <h1 class="prospectus-heading">FOURTH YEAR: 1ST SEMESTER</h1>
      <table class="prospectus-table" border="0" cellpadding="0" cellspacing="0">

        <?php
          echo $table_header;
          $subject_set = find_subject_by_yearlevel_semester_course('4th', '1st Sem.', $course);
          while($subject = mysqli_fetch_assoc($subject_set)){ ?>
      ...
      <?php //4th year 2nd sem ?>
      
      <h1 class="prospectus-heading">FOURTH YEAR: 2ND SEMESTER</h1>
      <table class="prospectus-table" border="0" cellpadding="0" cellspacing="0">

        <?php
          echo $table_header;
          $subject_set = find_subject_by_yearlevel_semester_course('4th', '2nd Sem.', $course);
          while($subject = mysqli_fetch_assoc($subject_set)){ ?>
